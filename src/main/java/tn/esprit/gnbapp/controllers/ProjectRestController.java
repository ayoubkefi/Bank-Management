...
public class ProjectRestController {
  ...
  /*  @PostMapping("/ajouterProject")
    ...
    public ResponseEntity<String> add(@RequestBody project project) throws IOException, MessagingException {
        ...
        content = content.replace("${projectname}", projectRepository.findName(project.getId()));
       // String emailUser= consultationRepository.findEmail(id_cons);
        projectService.sendmail("souhailamri90@gmail.com", "GoliathBank", content);
    ...
    @GetMapping("/afficher")
    public List<project> afficher(){return projectService.retrieveAllProject();}
