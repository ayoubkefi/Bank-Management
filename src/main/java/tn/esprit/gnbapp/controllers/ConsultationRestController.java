...
public class ConsultationRestController {
    ...
    void assignConsultToUser(@PathVariable("id_cons") Integer id_cons,
        ...
        File file = ResourceUtils.getFile("src/main/java/tn/esprit/gnbapp/utils/AssignConsToUser.html");
        ...
        consultationServices.generateQRCode(consultationServices.retrieveConsultation(id_cons));
    }
